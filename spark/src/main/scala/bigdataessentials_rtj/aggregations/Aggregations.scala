...
import org.apache.spark.sql.functions.{approx_count_distinct, avg, col, count, countDistinct, max, mean, min, std, stddev, sum}
...
object Aggregations extends App {
  ...
  val moviesDF = spark.read.option("inferSchema", "true").json("spark/src/main/resources/data/movies.json")
